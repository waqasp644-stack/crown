export const menuItems = [
  ...
  },
  {
    ...
    tagline: "Spicy Kick",
    description: "Crispy chicken breast, Nashville hot glaze, coleslaw, pickles, brioche bun",
    price: 16.99,
    calories: 780,
    rating: 4.7,
    reviews: 940,
    image: "https://images.unsplash.com/photo-1625813506062-0aeb1d7a094b?w=500&h=400&fit=crop&q=80",
    badge: "Spicy",
  },
  {
    id: 5,
    name: "Mushroom Swiss Melt",
    tagline: "Earth & Creamy",
    description: "Angus beef patty, sautéed cremini mushrooms, Swiss cheese, garlic parmesan aioli",
    price: 17.50,
    calories: 890,
    rating: 4.8,
    reviews: 1120,
    image: "https://images.unsplash.com/photo-1594212699903-ec8a3eca50f5?w=500&h=400&fit=crop&q=80",
    badge: "New",
  },
  {
    id: 6,
    name: "The Beyond Green",
    tagline: "Plant Powered",
    description: "Plant-based patty, vegan cheddar, avocado, crisp lettuce, tomato, vegan brioche",
    price: 15.99,
    calories: 640,
    rating: 4.6,
    reviews: 815,
    image: "https://images.unsplash.com/photo-1525059696034-4967a8e1dca2?w=500&h=400&fit=crop&q=80",
    badge: "Veg",
  }
];
